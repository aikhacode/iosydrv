...
const EditAccountName = (props) => {
    ...
    const check_valid = () => {
        if (bank_account_name) {
            ...
            dropDownAlertRef.alertWithType('error', 'Validation error', 'Please enter your account name');
        }
    }
    ...
    const call_update_kyc = () => {
        ...
        axios({
            ...
            data: { driver_id: global.id, field: 'bank_account_name', data: bank_account_name }
        })
            .then(async response => {
                setLoading(false);
                alt({
                    ...
                    message: 'Your account name has been sent. Please wait for admin approval.',
                });
    ...
    return (
        <SafeAreaView style={{ backgroundColor: colors.lite_bg, flex: 1 }}>
            ...
            <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                <Text numberOfLines={1} style={{ color: colors.theme_fg_two, fontSize: f_xl, fontFamily: bold }}>Masukan nama pemilik rekening bank</Text>
                <View style={{ margin: 5 }} />
                <Text numberOfLines={1} style={{ color: colors.grey, fontSize: f_xs, fontFamily: normal }}>Nama pemilik rekening bank yg aktif</Text>
                <View style={{ margin: 20 }} />
                <View style={{ width: '80%' }}>
