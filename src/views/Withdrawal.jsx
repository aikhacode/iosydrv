      ...
      <ScrollView>
        <View style={[styles.header]}>
          ...
          <View activeOpacity={1} style={{ width: '85%', alignItems: 'flex-start', justifyContent: 'center' }}>
            <Text numberOfLines={1} ellipsizeMode='tail' style={{ color: colors.theme_fg_three, fontSize: f_xl, fontFamily: bold }}>Ambil</Text>
          </View>
        </View>
        ...
        >
          <View style={{ backgroundColor: colors.theme_bg_three, width: '100%', padding: 20, alignItems: 'center', justifyContent: 'center', borderRadius: 10, flexDirection: 'row' }}>
            ...
            <View style={{ width: '75%', alignItems: 'flex-start', justifyContent: 'center' }}>
              <Text numberOfLines={1} style={{ color: colors.text_grey, fontSize: f_s, fontFamily: normal }}>Saldo saat ini</Text>
              <Text numberOfLines={1} style={{ color: colors.theme_fg_two, fontSize: f_m, fontFamily: bold, marginTop: 10, marginBottom: 10 }}>{formatCurrency(w_amount)}</Text>
            </View>
          </View>
