...
const EditEmail = (props) => {
    ...
    const call_profile_update = () => {
        ...
        axios({
            ...
            data: { driver_id: global.id, field: 'email', data: email }
        })
            .then(async response => {
                setLoading(false);
                alt({
                    ...
                    message: 'Your email has been sent. Please wait for admin approval.',
                });
    ...
    return (
        <SafeAreaView style={{ backgroundColor: colors.lite_bg, flex: 1 }}>
            ...
            <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                <Text numberOfLines={1} style={{ color: colors.theme_fg_two, fontSize: f_xl, fontFamily: bold }}>Masukan email</Text>
                <View style={{ margin: 5 }} />
                <Text numberOfLines={1} style={{ color: colors.grey, fontSize: f_xs, fontFamily: normal }}>Email aktif kamu</Text>
                <View style={{ margin: 20 }} />
                <View style={{ width: '80%' }}>
