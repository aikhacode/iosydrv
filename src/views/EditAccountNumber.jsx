...
const EditAccountNumber = (props) => {
    ...
    const call_update_kyc = () => {
        ...
        axios({
            ...
            data: { driver_id: global.id, field: 'bank_account_number', data: account_number }
        })
            .then(async response => {
                setLoading(false);
                alt({
                    ...
                    message: 'Your account number has been sent. Please wait for admin approval.',
                });
    ...
    return (
        <SafeAreaView style={{ backgroundColor: colors.lite_bg, flex: 1 }}>
            ...
            <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                <Text numberOfLines={1} style={{ color: colors.theme_fg_two, fontSize: f_xl, fontFamily: bold }}>Masukan nomer rekening bank</Text>
                <View style={{ margin: 5 }} />
                <Text numberOfLines={1} style={{ color: colors.grey, fontSize: f_xs, fontFamily: normal }}>Nomer rekening bank yg aktif</Text>
                <View style={{ margin: 20 }} />
                <View style={{ width: '80%' }}>
