...
const OTP = (props) => {
    ...
    const navigate = async () => {
        if (from == "register") {
            ...
            navigation.navigate('Password', { phone_number: phone_with_code });
        }
        else if (from == "forgot") {
    ...
    return (
        <SafeAreaView style={{ backgroundColor: colors.lite_bg, flex: 1 }}>
            ...
            <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                ...
                <View style={{ margin: 5 }} />
                <Text numberOfLines={1} style={{ color: colors.grey, fontSize: f_xs, fontFamily: normal }}>Check OTP from your Whatsapp</Text>
                <View style={{ margin: 20 }} />
                <View style={{ width: '80%' }}>
