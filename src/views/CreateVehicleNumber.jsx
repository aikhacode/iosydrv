...
const CreateVehicleNumber = (props) => {
    ...
    const { setVehicleNumber, vehicleNumber } = useRegistrationStore()
    let alt = useRef(
    ...
    return (
        <SafeAreaView style={{ backgroundColor: colors.lite_bg, flex: 1 }}>
            ...
            <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                <Text numberOfLines={1} style={{ color: colors.theme_fg_two, fontSize: f_xl, fontFamily: bold }}>Masukaan plat nomer kendaraan</Text>
                <View style={{ margin: 5 }} />
                <Text numberOfLines={1} style={{ color: colors.grey, fontSize: f_xs, fontFamily: normal }}>Plat nomer diperlukan</Text>
                <View style={{ margin: 20 }} />
                <View style={{ width: '80%' }}>
