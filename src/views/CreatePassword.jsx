    ...
    const check_password = () => {
        if (password == confirm_password) {
            ...
            alt({
                type: DropdownAlertType.Error,
                title: 'Validation error',
                message: 'Password dan konfirm password tidak cocok',
            });
        ...
        await axios({
            ...
            .catch(error => {
                ...
                alt({
                    type: DropdownAlertType.Error,
                    title: 'Error',
                    message: 'Maaf terjadi error saat pendaftaran',
                });
        ...
        <SafeAreaView style={{ backgroundColor: colors.lite_bg, flex: 1 }}>
            ...
            {registration_status == 0 ?
                <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                    <Text numberOfLines={1} style={{ color: colors.theme_fg_two, fontSize: f_xl, fontFamily: bold }}>Buat password</Text>
                    <View style={{ margin: 5 }} />
                    <Text numberOfLines={1} style={{ color: colors.grey, fontSize: f_xs, fontFamily: normal }}>Buat password baru</Text>
                    <View style={{ margin: 20 }} />
                    <View style={{ width: '80%' }}>
                ...
                <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <View style={{ margin: 5 }} />
                    <Text style={{ color: colors.grey, fontSize: f_xs, fontFamily: normal, textAlign: 'center', width: '80%' }}>Pendaftaran berhasil, silakan login menggunakan no telpon</Text>
                    <View style={{ margin: 20 }} />
...
function mapStateToPropsReg(state) {
    return {
...
export default connect(mapStateToPropsReg, null)(CreatePassword);