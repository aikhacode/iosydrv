...
import { useGlobalStore } from './src/reducers/zustand';
...
import NominalPickView from './src/components/Topup/NominalPick';
import EditAccountName from './src/views/EditAccountName';
import BankTransferPickView from './src/components/Topup/BankTransferPick';
import TransferDetailView from './src/components/Topup/TransferDetailView';
import PPOBView from './src/components/ppob/ppobmain';
import PulsaComponent from './src/components/ppob/pulsa';
import PlnComponent from './src/components/ppob/pln';
import PLNComponent from './src/components/ppob/pln';
import EMoneyComponent from './src/components/ppob/emoney';
import ETolComponent from './src/components/ppob/etol';
import OnewayComponent from './src/components/map/Oneway';
import EditPlatNo from './src/views/EditPlatNo';
import WalletTransaction from './src/views/WalletTransaction';
import MailBody from './src/views/MailBody';

const TabArr = [
  { route: 'Dashboard', label: 'Home', type: Icons.FontAwesome, icon: 'home', component: Dashboard, color: colors.theme_fg, alphaClr: colors.theme_bg_three },
  { route: 'Mails', label: 'Pesan', type: Icons.MaterialIcons, icon: 'mail', component: Mails, color: colors.theme_fg, alphaClr: colors.theme_bg_three },
    ...
    <TouchableOpacity
      ...
      <View>
        ...
        <View style={[styles.btn, { backgroundColor: focused ? null : item.alphaClr }]}>
          ...
          <WithIcon type={item.type} name={item.icon} color={focused ? colors.theme_fg_three : colors.grey}
            style={{
              height: '110%', top: 10
            }}
          />
...
function TabNavigator() {
  const isShowTabNavigator = useGlobalStore((state) => state.isShowTabNavigator)
  ...
  return (
    <Tab.Navigator
      screenOptions={{
        ...
        //   left: 16,
        //   // borderRadius: 16,
        //   display: isShowTabNavigator ? 'flex' : 'none'
        //   // display: 'flex'
        // }
        tabBarStyle: {
          height: 64 + bottom,
    ...
    <SafeAreaProvider>
      <NavigationContainer>
        <Stack.Navigator initialRouteName="Splash" screenOptions={({ route, navigation }) => ({
          ...
          <Stack.Screen name="EditPlatNo" component={EditPlatNo} options={{ headerShown: false }} />
        ...
        <Stack.Screen name="TrainingDetails" component={TrainingDetails} options={{ headerShown: false }} /> */}
          ...
          <Stack.Screen name="WalletTransaction" component={WalletTransaction} options={{ headerShown: false }} />
          ...
          <Stack.Screen name="EditAccountName" component={EditAccountName} options={{ headerShown: false }} />
          ...
          <Stack.Screen name="WebRender" component={WebRender} options={{ headerShown: false }} />
          <Stack.Screen name="TopupDetailView" component={TopupDetailView} options={{ headerShown: false }} />
          <Stack.Screen name="TransferDetailView" component={TransferDetailView} options={{ headerShown: false }} />
          <Stack.Screen name="BankPickView" component={BankPickView} options={{ headerShown: false }} />
          <Stack.Screen name="BankTransferPickView" component={BankTransferPickView} options={{ headerShown: false }} />
          <Stack.Screen name="NominalPickView" component={NominalPickView} options={{ headerShown: false }} />
          <Stack.Screen name="PPOB" component={PPOBView} options={{ headerShown: false }} />
          <Stack.Screen name="Pulsa" component={PulsaComponent} options={{ headerShown: false }} />
          <Stack.Screen name="PLN" component={PLNComponent} options={{ headerShown: false }} />
          <Stack.Screen name="EMoney" component={EMoneyComponent} options={{ headerShown: false }} />
          <Stack.Screen name="ETol" component={ETolComponent} options={{ headerShown: false }} />
